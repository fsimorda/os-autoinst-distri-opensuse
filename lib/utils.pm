...
sub need_unlock_after_bootloader {
    ...
    my $need_unlock_after_bootloader = is_sle('=15-sp7') || is_leap('<15.6') || is_sle('<15-sp6') || is_leap_micro || is_sle_micro || (!get_var('LVM', '0') && !get_var('FULL_LVM_ENCRYPT', '0')) || $is_enc_cc_s390x;
